...
/// Design tokens transcribed from `TutorLinkTutor.dc.html`. Every value here has a direct
...
class TLTokens extends ThemeExtension<TLTokens> {
  ...
  static const Color accent = Color(0xFF66328E);
  ...
  static const TLTokens dark = TLTokens(
    bg: Color(0xFF0D0B12),
    card: Color(0xFF18151F),
    cardAlt: Color(0xFF241F2D),
    text: Color(0xFFF2F1F5),
    textSub: Color(0x9EEEEBF5),
    border: Color(0x17FFFFFF),
    input: Color(0xFF1E1A26),
    navBg: Color(0xEB16131B),
    sheet: Color(0xFF1C1826),
