...
class TLAssets {
  ...
  /// "New Course" promo illustration behind the Home banner.
  static const String newCourses = 'assets/svgs/newcourses.svg';

  /// Filter glyph on Explore — matches the design's own filter mark.
  static const String iconFilter = 'assets/svgs/filter.svg';
