          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  last?.text ?? 'Ask me anything about your courses',
                  maxLines: 1,
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            Text('AI Study Assistant', style: TLText.cardTitle(t.text)),
          ],
        ),
        actions: [
...
/// Floating shortcut into the assistant, shown over every tab so the student
...
class AiFab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      button: true,
      label: 'Open the AI study assistant',
      child: Container(
        width: 58,
        height: 58,
        decoration: BoxDecoration(
