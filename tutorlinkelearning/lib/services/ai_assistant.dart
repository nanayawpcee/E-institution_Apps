...
/// System prompt for the student-facing assistant, from the design doc.
const String kStudentAssistantPrompt =
    'You are the AI study assistant inside a tutoring app called TutorLink. '
    'Be warm, concise and encouraging. Keep answers under 90 words, use plain '
    'text with no markdown.';

final aiAssistantProvider =
    StateNotifierProvider<AiAssistantNotifier, AiAssistantState>((ref) {
  return AiAssistantNotifier(systemPrompt: kStudentAssistantPrompt);
});
